...
class Train(object):
    ...
    def do_val(self, val_num):
        ...
        additional_text2='_pos2con'+str(np.mean(c_pos_context))[:4]+'_pos2pan'+str(np.mean(c_pos_pattern))[:4]+\
            '_pan2con'+str(np.mean(c_pan_context))[:4]+'_pan2pan'+str(np.mean(c_pan_pattern))[:4]+\
